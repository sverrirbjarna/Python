...
pathg = "/home/sverrir/Documents/Yolo_data/Detection images/rgb_"+str(nr)+".txt"
pathp = "/home/sverrir/Documents/Yolo_data/run20jan/Detections/"+str(nr)+".txt"
...
photopath = "/home/sverrir/Documents/Yolo_data/Detection images/rgb_"+str(nr)+".png"
...
cv2.imwrite("/home/sverrir/Documents/Yolo_data/run20jan/Detections/IOU"+str(nr)+".png", image)
# cv2.waitKey(0)
